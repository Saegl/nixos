return {
    {
        ...
        config = function()
            ...
            vim.keymap.set('n', '<leader>smf', function() builtin.find_files({ cwd = "~/shared/notes/" }) end,
                { desc = '[S]earch [F]iles in my notes directory' })
            ...
            vim.keymap.set('n', '<leader>smg', function() builtin.live_grep({ cwd = "~/shared/notes/" }) end,
                { desc = '[S]earch by [G]rep in my notes directory' })
            ...
            vim.keymap.set('n', '<leader>sx', function()
                builtin.find_files { cwd = '/home/saegl/projects/nix/nixos' }
