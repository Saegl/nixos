...
vim.keymap.set("n", "<leader>s*", fzf.grep_cword, { desc = "Grep word under cursor" })
...
vim.keymap.set('n', '<leader>bo', '<cmd>BufferLineCloseRight<cr>', { desc = "Close buffers to the right" })
